...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '랜계최저가 MELTSHOP' }, status: 'online' })
});
...
client.on('message', (message) => {
  ...
  if(message.content == 'ㅋㅋ') {
    return message.reply('ㅋㅋㅋㅋㅋ');
  }

  if(message.content == 'embe') {
    ...
    if(message.member != null) { // 채널에서 공지 쓸 때
      ...
      let embed = new Discord.RichEmbed()
        ...
        .setImage('https://cdn.discordapp.com/attachments/755601938657050624/755682681504923668/ezgif-1-09af1203224e.gif')
